...
public class DatadrivenTesting1 {
	...
	{
		driver.findElement(By.linkText("REGISTER")).click();
		FileInputStream f=new FileInputStream("D:\\Selenium_Projects\\SeleniumPrograms-master\\src\\com\\qedge\\excelfiles\\registration.xlsx");
		...
		FileOutputStream f1=new FileOutputStream("D:\\Selenium_Projects\\SeleniumPrograms-master\\src\\com\\qedge\\resultexcelfiles\\registration.xlsx");
		wb.write(f1);
		f1.close();
		driver.close();
	}
